...
export default function Hero() {
  ...
  const textArray = ["Full Stack Developer", "Tech Enthusiast", "Software Developer", "Bootcamp Graduate", "Rock Climber", "TCG Collector and Player", "Outdoorsman"]; // Pre-defined text
